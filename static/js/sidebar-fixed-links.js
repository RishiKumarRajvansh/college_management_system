// sidebar-fixed-links.js - Fix for sidebar links not working
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fix for links inside dropdowns - prevent dropdown toggle from canceling navigation
    document.querySelectorAll('.sidebar-menu .dropdown-item').forEach(link => {
        link.addEventListener('click', function(e) {
            // Don't stop propagation to allow the link to work
            // We just need to prevent the dropdown toggle from interfering
