// Fixed sidebar JavaScript implementation
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.sidebar-menu .dropdown-toggle').forEach(toggle => {
        ...
        toggle.addEventListener('click', function(e) {
            ...
            // For regular links, let the default behavior happen (navigation)
        });
    });
    
    // Handle dropdown item clicks - these should navigate
    document.querySelectorAll('.sidebar-menu .dropdown-item').forEach(item => {
    ...
    document.querySelectorAll('#sidebar-wrapper .nav-link, #sidebar-wrapper .dropdown-item').forEach(link => {
